...
- [doc/换电脑迁移Prompt.md](file://doc/换电脑迁移Prompt.md)
</cite>

## 更新摘要
**变更内容**   
- 在附录部分新增了"换电脑迁移Prompt"的引用，完善了开发环境相关的文档体系
- 扩展了新电脑快速上手提示的内容范围，涵盖设备迁移场景
...
- 换电脑迁移指南
  - 当需要更换开发设备时，请参考"换电脑迁移Prompt"文档，该指南提供了完整的环境迁移流程，包括依赖包迁移、配置文件备份、数据库连接配置等关键步骤，确保在新设备上快速恢复完整的开发环境

章节来源
- [doc/新电脑快速安装心芽程序Prompt.md:1-78](file://doc/新电脑快速安装心芽程序Prompt.md#L1-L78)
- [doc/换电脑迁移Prompt.md:1-100](file://doc/换电脑迁移Prompt.md#L1-L100)