...
图表来源
- [useTheme.ts:1-29](file://lib/useTheme.ts#L1-L29)
- [layout.tsx（根布局）:1-43](file://app/layout.tsx#L1-L43)
- [layout.tsx（主布局）:1-173](file://app/(main)/layout.tsx#L1-L173)
- [root/page.tsx:1-718](file://app/(main)/root/page.tsx#L1-L718)
...
图表来源
- [root/page.tsx:154-171](file://app/(main)/root/page.tsx#L154-L171)
...
- 初始化：优先读取服务器返回的用户主题，覆盖本地存储，确保多端一致。

```mermaid
sequenceDiagram
participant U as "用户"
participant RP as "RootPage.changeTheme"
participant LS as "localStorage"
participant EVT as "Window 事件"
participant API as "/api/theme"
participant DB as "数据库"
U->>RP : 选择主题
RP->>LS : 写入 xinya-theme
RP->>EVT : 派发 xinya-theme-change
RP->>API : PATCH { theme }
...
章节来源
- [root/page.tsx:105-171](file://app/(main)/root/page.tsx#L105-L171)
- [theme/route.ts:1-15](file://app/api/theme/route.ts#L1-L15)
