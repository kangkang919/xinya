      ...
      >
        <div className="flex items-end justify-around px-2 pt-2 pb-1 max-w-lg mx-auto">
          ...
          >
            ...
            <span className="text-[10px] font-medium">钀岃娊</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-medium">鏋濆彾</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-medium">骞磋疆</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-medium">鏍圭郴</span>
          </button>
        </div>
      </nav>
    </div>
...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    function applyFromStorage() {
      const theme = localStorage.getItem('xinya-theme') || 'autumn'
      setBg(THEME_BG[theme] || '#FAFAF5')
    }
    applyFromStorage()
    window.addEventListener('xinya-theme-change', applyFromStorage)
    return () => window.removeEventListener('xinya-theme-change', applyFromStorage)
