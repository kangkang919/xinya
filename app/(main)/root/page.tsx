...
const CHANGELOGS = [
  {
    version: 'v0.2.0',
    date: '2026年8月',
    prose: '一株幼苗，渐渐长出了自己的模样。标签有了层次，心得可以排序，月度洞察帮你回望成长，分享链接让他人也能走进你的花园。',
    items: [
      '标签层级化：父子两级标签，枝叶页分组折叠展示',
      '心得拖拽排序：每个标签下独立排序，持久化保存',
      'AI 月度洞察：月末自动总结，回望成长轨迹',
      '分享管理：一键生成链接，访客只读体验',
      '交互增强：详情可删除、返回恢复位置、画像可重播',
      '视觉焕新：根系页与年轮页统一重设计',
    ],
  },
  {
