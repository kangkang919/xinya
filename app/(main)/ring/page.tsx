    ...
    <div className="p-4 max-w-lg mx-auto pb-24">
      ...
      <div className="flex items-center justify-between mb-4 px-1">
        <button
          ...
          style={{ color: "#8BC34A", background: isDark ? "rgba(139,195,74,0.2)" : "rgba(139,195,74,0.1)", border: "none", fontSize: "20px", cursor: "pointer" }}
        >
          ‹
        </button>
        <span className="text-base font-semibold" style={{ color: titleColor, display: "flex", alignItems: "center", gap: "8px" }}>
          {stats.label}
          {isCurrentMonth && (
            <span className="text-xs px-2 py-0.5 rounded-full" style={{ background: isDark ? "rgba(139,195,74,0.2)" : "rgba(139,195,74,0.12)", color: "#8BC34A", fontWeight: 500 }}>
              今
            </span>
          )}
        </span>
      ...
      <div className="grid grid-cols-3 gap-3 mb-3" style={{ minHeight: "80px" }}>
        <div className="p-4 rounded-xl text-center" style={{ background: isDark ? "rgba(139,195,74,0.15)" : "rgba(139,195,74,0.08)" }}>
          <p className="text-2xl font-bold" style={{ color: "#8BC34A" }}>{stats.total}</p>
          <p className="text-xs mt-1" style={{ color: "#999" }}>本月篇数</p>
        </div>
        <div className="p-4 rounded-xl text-center" style={{ background: isDark ? "rgba(66,165,245,0.15)" : "rgba(66,165,245,0.08)" }}>
        ...
        <div className="p-4 rounded-xl text-center" style={{ background: isDark ? "rgba(255,140,66,0.15)" : "rgba(255,140,66,0.08)" }}>
